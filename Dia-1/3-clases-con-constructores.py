class Silla:
    def __init__(self, ancho, alto, num_patas) -> None:
        # self > sirve para hacer referencia a la misma instancia de la clase, para evitar que se cambien los datos de otras instancias
        self.ancho = ancho
        self.alto = alto
