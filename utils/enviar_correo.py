...
>
  ...
  >
    ...
    # en el caso de Hotmal lo adjunta como archivo
    ...
    # cerra la conexion con mi servidor de correos
    emisor.quit()
...
def enviar_correo_adjuntos(destinatarios, titulo):
    ...
    # getcwd > nos devuleve la ruta en la cual está nuestro archivo principal del proyecto en el servidor (app.py)
    ruta = getcwd()
    # path.join > en base a los parámetros que nosotros le pasemos, creará la cadena de direccion ya sea con '/' o '\'
    ...
    # luego de que se terminó la lectura del archivo
