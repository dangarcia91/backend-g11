...
SECRET_KEY = 'django-insecure-z2e(x^%i0ai7rn+m!tz^&ivzt3loe0j1ge%ocis5rzys+k)uh)'
...
DATABASES = {
    'default': {
        ...
        'HOST': 'localhost', # el host donde se ubicará mi base de datos
        'USER': 'postgres', # el usuario de la base de datos
        'PASSWORD': 'data23', # la contraseña de la base de datos
        #'PORT': 5432 # puerto de la base de deatos
    }
}
